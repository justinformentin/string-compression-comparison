import { LZW } from '../../local-libs/lzw.js'
import { lzw_encode, encode_utf8, decode_utf8, lzw_decode } from '../../local-libs/lzw-map.js'
import LZUTF8 from 'lzutf8'
import lzjs from 'lzjs'
import { LZString } from '../../local-libs/lz-string.js'
